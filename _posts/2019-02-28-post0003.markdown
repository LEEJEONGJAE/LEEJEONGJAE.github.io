...
*<span class="lm20">1. nodejs 설치</span>
* **1. nodejs 설치**
...
**3. npm 사용하기**
 <a class="list_circle lm20">npm : node pakage manager</a>
 <a class="list_disc lm30">url : http://pm2.keymetrics.io/</a>
 <a class="list_disc lm30">pm2 설치</a>
 <a class="list_circle lm40">윈도우 : 관리자권한으로 cmd 실행 > 'npm install pm2 -g'</a>
 ~~~node
 > npm install pm2 -g
 ~~~
